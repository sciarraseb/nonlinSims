...
sample_output$minus_2_likelihood <- as.numeric(sample_output$minus_2_likelihood)
sample_output$theta_fixed <- as.numeric(sample_output$theta_fixed)
sample_output$alpha_fixed <- as.numeric(sample_output$alpha_fixed)
sample_output$beta_fixed <- as.numeric(sample_output$beta_fixed)
sample_output$gamma_fixed <- as.numeric(sample_output$gamma_fixed)

sample_output$theta_rand <- as.numeric(sample_output$theta_rand)
sample_output$alpha_rand <- as.numeric(sample_output$alpha_rand)
sample_output$beta_rand <- as.numeric(sample_output$beta_rand)
sample_output$gamma_rand<- as.numeric(sample_output$gamma_rand)
sample_output$epsilon<- as.numeric(sample_output$epsilon)


sample_output[ ,c(6:10, 13, 14)] <- round(x = sample_output[ ,c(6:10, 13, 14)], 2)
sample_output[ ,c(11,12,15)] <- round(x = sample_output[ ,c(11,12,15)], 4)

write_csv(x = sample_output, file = 'sample_output.csv')
...
start_values <- start_values <- compute_starting_values_4l(data = data)

model <- create_logistic_growth_model_4l(data_wide = data_wide, model_name = 'test', starting_values = start_values)
