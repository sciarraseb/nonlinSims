...
packages <- c('tidyverse', 'data.table', "OpenMx", 'devtools', 'nonlinSims')
libraries(packages)
...
output <- mxTryHard(mxAutoStart(model),extraTries = 10)
summary(output)
...
test_convergence(factor_list = factor_list, num_iterations = 3, pop_params = pop_params, response_group_size = 225, num_cores = 3)
