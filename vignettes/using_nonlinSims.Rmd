...
create_logistic_growth_model(data_wide = data, model_name = 'sf') 
...
results <- compute_mult_simulations(num_iterations = 5, pop_params = pop_params, cov_matrix = cov_matrix, schedule = schedule,
...
compute_middle_extreme_schedule(time_period = 360, num_measurements = 5, base_time_length = 20)
