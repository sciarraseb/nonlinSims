...
factor_list <- list('num_measurements' = seq(from = 5, to = 11, by = 2), 
                    'spacing' = c('equal', 'time_inc', 'time_dec', 'mid_ext'), 
                    'midpoint' = seq(from = 80, to = 280, by = 100))


sample_output <- run_exp_simulation_4l(factor_list = factor_list, num_iterations = 2, pop_params = pop_params_4l, response_group_size = 50, num_cores = 3, seed = 27)
