...
#' @export
run_exp_simulation <- function(factor_list, num_iterations, pop_params, response_group_size, num_cores, seed) {
...
run_ind_simulation <- function(num_iterations, pop_params, cov_matrix, measurement_spacing, schedule, response_group_size){
